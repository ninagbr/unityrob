// Generated by gencpp from file robots_start/MoveitJoints.msg
// DO NOT EDIT!


#ifndef ROBOTS_START_MESSAGE_MOVEITJOINTS_H
#define ROBOTS_START_MESSAGE_MOVEITJOINTS_H
...
struct MoveitJoints_
{
  typedef MoveitJoints_<ContainerAllocator> Type;
  ...
  MoveitJoints_(const ContainerAllocator& _alloc)
    : joints_input_01()
    , joints_input_02()
    , joints_input_03()
    , bms(_alloc)
  ...
  typedef boost::shared_ptr< ::robots_start::MoveitJoints_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robots_start::MoveitJoints_<ContainerAllocator> const> ConstPtr;

}; // struct MoveitJoints_

typedef ::robots_start::MoveitJoints_<std::allocator<void> > MoveitJoints;

typedef boost::shared_ptr< ::robots_start::MoveitJoints > MoveitJointsPtr;
typedef boost::shared_ptr< ::robots_start::MoveitJoints const> MoveitJointsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robots_start::MoveitJoints_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robots_start::MoveitJoints_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robots_start::MoveitJoints_<ContainerAllocator1> & lhs, const ::robots_start::MoveitJoints_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robots_start::MoveitJoints_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robots_start::MoveitJoints_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robots_start::MoveitJoints_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robots_start::MoveitJoints_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robots_start::MoveitJoints_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robots_start::MoveitJoints_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robots_start::MoveitJoints_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robots_start::MoveitJoints_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x131e2d50b00081c2ULL;
  static const uint64_t static_value2 = 0xb4c34a10d3bf6f0cULL;
};

template<class ContainerAllocator>
struct DataType< ::robots_start::MoveitJoints_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robots_start::MoveitJoints_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robots_start::MoveitJoints_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robots_start::MoveitJoints_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robots_start::MoveitJoints_<ContainerAllocator>& v)
  {
...
#endif // ROBOTS_START_MESSAGE_MOVEITJOINTS_H
