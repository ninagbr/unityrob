...
(cl:defmethod cl:initialize-instance :after ((m <NiryoTrajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NiryoTrajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robots_start-msg:<NiryoTrajectory> is deprecated: use robots_start-msg:NiryoTrajectory instead.")))

(cl:ensure-generic-function 'trajectories_01-val :lambda-list '(m))
(cl:defmethod trajectories_01-val ((m <NiryoTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_start-msg:trajectories_01-val is deprecated.  Use robots_start-msg:trajectories_01 instead.")
  (trajectories_01 m))

(cl:ensure-generic-function 'trajectories_02-val :lambda-list '(m))
(cl:defmethod trajectories_02-val ((m <NiryoTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_start-msg:trajectories_02-val is deprecated.  Use robots_start-msg:trajectories_02 instead.")
  (trajectories_02 m))

(cl:ensure-generic-function 'trajectories_03-val :lambda-list '(m))
(cl:defmethod trajectories_03-val ((m <NiryoTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robots_start-msg:trajectories_03-val is deprecated.  Use robots_start-msg:trajectories_03 instead.")
  (trajectories_03 m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<NiryoTrajectory>)))
  ...
  "4a037a36e85c04e8b51dd70f99ba6175")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'NiryoTrajectory)))
  "Returns md5sum for a message object of type 'NiryoTrajectory"
  "4a037a36e85c04e8b51dd70f99ba6175")
