...
(cl:defclass <MoveitJoints> (roslisp-msg-protocol:ros-message)
  ((joints_input_01
...
(cl:defclass MoveitJoints (<MoveitJoints>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MoveitJoints>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MoveitJoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robots_start-msg:<MoveitJoints> is deprecated: use robots_start-msg:MoveitJoints instead.")))

(cl:ensure-generic-function 'joints_input_01-val :lambda-list '(m))
(cl:defmethod joints_input_01-val ((m <MoveitJoints>))
...
(cl:defmethod joints_input_02-val ((m <MoveitJoints>))
...
(cl:defmethod joints_input_03-val ((m <MoveitJoints>))
...
(cl:defmethod bms-val ((m <MoveitJoints>))
...
(cl:defmethod place_pose-val ((m <MoveitJoints>))
...
(cl:defmethod batterylock1-val ((m <MoveitJoints>))
...
(cl:defmethod batterylock2-val ((m <MoveitJoints>))
...
(cl:defmethod batterylock3-val ((m <MoveitJoints>))
...
(cl:defmethod batterylock4-val ((m <MoveitJoints>))
  ...
  (batterylock4 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MoveitJoints>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MoveitJoints>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveitJoints>)))
  "Returns string type for a message object of type '<MoveitJoints>"
  "robots_start/MoveitJoints")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveitJoints)))
  "Returns string type for a message object of type 'MoveitJoints"
  "robots_start/MoveitJoints")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoveitJoints>)))
  "Returns md5sum for a message object of type '<MoveitJoints>"
  "131e2d50b00081c2b4c34a10d3bf6f0c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoveitJoints)))
  "Returns md5sum for a message object of type 'MoveitJoints"
  "131e2d50b00081c2b4c34a10d3bf6f0c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoveitJoints>)))
  "Returns full string definition for message of type '<MoveitJoints>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoveitJoints)))
  "Returns full string definition for message of type 'MoveitJoints"
  (cl:format cl:nil "float64[6] joints_input_01~%float64[6] joints_input_02~%float64[6] joints_input_03~%geometry_msgs/Pose bms~%geometry_msgs/Pose place_pose~%geometry_msgs/Pose batterylock1~%geometry_msgs/Pose batterylock2~%geometry_msgs/Pose batterylock3~%geometry_msgs/Pose batterylock4~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MoveitJoints>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MoveitJoints>))
  "Converts a ROS message object to a list"
  (cl:list 'MoveitJoints
