...
# 
	pose105 = plan_trajectory02(group2, req.target105, previous_ending_joint_angles)
...
#	
   ...
   #	
    ...
    # 
	pose113 = plan_trajectory03(group3, req.target113, previous_ending_joint_angles)
