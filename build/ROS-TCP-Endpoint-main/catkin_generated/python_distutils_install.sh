...
echo_and_run cd "/home/nina/ws_unity/src/ROS-TCP-Endpoint-main"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/nina/ws_unity/build/ROS-TCP-Endpoint-main \
    build --build-base "/home/nina/ws_unity/build/ROS-TCP-Endpoint-main" \
    install \
    --root="${DESTDIR-/}" \
