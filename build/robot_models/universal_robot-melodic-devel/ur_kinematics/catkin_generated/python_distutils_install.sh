...
echo_and_run cd "/home/nina/ws_unity/src/robot_models/universal_robot-melodic-devel/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/home/nina/ws_unity/src/robot_models/universal_robot-melodic-devel/ur_kinematics/setup.py" \
     \
    build --build-base "/home/nina/ws_unity/build/robot_models/universal_robot-melodic-devel/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
